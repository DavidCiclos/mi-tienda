...
export default function Home() {
  ...
  // PRODUCTOS CON NOMBRES PROTEGIDOS (Sin marcas registradas)
  const products = [
    { id: 1, name: "Deep Sea Elite 1.1", style: "PROFESIONAL", price: 850000, tier: "TOP TIER", images: ["https://unsplash.com"], specs: ["Acero Quirúrgico 316L", "Bisel Cerámico", "Movimiento Automático", "Garantía 2 Años"] },
    { id: 2, name: "Square Skeleton Gold", style: "CLÁSICO", price: 980000, tier: "TOP TIER", images: ["https://unsplash.com"], specs: ["Oro Ionizado 18k", "Cristal de Alta Resistencia", "Cierre Mariposa"] },
    { id: 3, name: "Waffle Dial Heritage", style: "CLÁSICO", price: 580000, tier: "PREMIUM", images: ["https://unsplash.com"], specs: ["Tablero Tapisserie 3D", "Acero Integrado", "Reserva de Marcha 40h"] },
    { id: 4, name: "Exotic Carbon Tourbillon", style: "EXÓTICO", price: 1250000, tier: "EXOTIC", images: ["https://unsplash.com"], specs: ["Caja de Carbono Forjado", "Cristal Curvo", "Maquinaria Visible"] },
    { id: 5, name: "Big Chief Tactical", style: "MODA", price: 280000, tier: "LIFESTYLE", images: ["https://unsplash.com"], specs: ["Cronógrafo Funcional", "Gran Formato", "Correa de Cuero Genuino"] }
  ];
  ...
  return (
    <div style={{ background: "#fcfcfc", color: "#0D1B2A", minHeight: "100vh", fontFamily: "sans-serif" }}>
      ...
      <header style={{ background: "#0D1B2A", padding: "50px 5%", textAlign: "center" }}>
        ...
        <p style={{ color: "#FFF", fontSize: "11px", letterSpacing: "5px", margin: 0, opacity: 0.8 }}>CURADURÍA DE PIEZAS SELECTAS</p>
      </header>

      {/* FILTROS POR ESTILO (Más seguro legalmente) */}
      <nav style={{ padding: "20px 5%", background: "white", borderBottom: "1px solid #f0f0f0", textAlign: "center", position: "sticky", top: 0, zIndex: 90, overflowX: "auto", whiteSpace: "nowrap" }}>
        {["TODOS", "PROFESIONAL", "CLÁSICO", "EXÓTICO", "MODA"].map(s => (
          <button key={s} onClick={() => setStyleFilter(s)} style={{ 
            ...
            border: "1px solid #0D1B2A", padding: "8px 20px", fontSize: "10px", cursor: "pointer", margin: "0 5px", transition: "0.3s", letterSpacing: "2px"
          }}>{s}</button>
        ))}
      </nav>
      ...
      <main style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "15px", padding: "15px", maxWidth: "1200px", margin: "0 auto" }}>
        {filteredProducts.map(p => (
          <div key={p.id} onClick={() => setSelectedProduct(p)} style={{ background: "white", padding: "12px", border: "1px solid #f0f0f0", textAlign: "center", cursor: "pointer", borderRadius: "8px" }}>
            ...
            <h3 style={{ fontSize: "12px", margin: "0 0 8px 0", color: "#1a1a1a", height: "32px", overflow: "hidden" }}>{p.name}</h3>
      ...
      <footer style={{ padding: "60px 5%", background: "#0D1B2A", color: "white", textAlign: "center" }}>
        <button onClick={() => setShowTerms(true)} style={{ background: "none", border: "1px solid #E0C56E", color: "#E0C56E", padding: "12px 25px", fontSize: "11px", cursor: "pointer", borderRadius: "4px", fontWeight: "bold" }}>
      ...
      {selectedProduct && (
        <div style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "100%", background: "white", zIndex: 1000, overflowY: "auto" }}>
          <div style={{ padding: "15px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid #eee" }}>
            <span style={{ fontWeight: "bold", fontSize: "13px" }}>ESPECIFICACIONES DE PIEZA</span>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", padding: "20px 5%" }}>
            <div style={{ flex: "1 1 350px", textAlign: "center", background: "#f9f9f9", borderRadius: "10px", padding: "20px" }}>
              <img src={selectedProduct.images} style={{ width: "100%", maxWidth: "450px" }} />
            </div>

            <div style={{ flex: "1 1 350px", padding: "20px" }}>
              <span style={{ color: "#E0C56E", fontWeight: "bold", fontSize: "11px", letterSpacing: "2px" }}>ESTILO {selectedProduct.style} | {selectedProduct.tier}</span>
              ...
              <div style={{ background: "#f9f9f9", borderLeft: "4px solid #E0C56E", padding: "15px", margin: "20px 0" }}>
                <p style={{ fontWeight: "bold", fontSize: "12px", marginBottom: "8px" }}>DETALLES:</p>
      ...
      {showTerms && (
        <div style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "100%", background: "white", zIndex: 2000, overflowY: "auto", padding: "40px 8%" }}>
          ...
          <div style={{ fontSize: "14px", lineHeight: "1.8", color: "#333", marginTop: "20px" }}>
            <p><strong>1. PROPIEDAD INTELECTUAL:</strong> APEX TIME es una curaduría independiente. Los nombres de marcas externas mencionados en comunicaciones privadas o sugeridos por el diseño son propiedad de sus respectivos dueños. Nuestras piezas son homenajes de alta ingeniería (Grado 1.1) y no guardan relación oficial con ninguna casa relojera internacional.</p>
            <p><strong>2. PERITAJE TÉCNICO:</strong> Debido al alto valor de los componentes (Acero 316L, Maquinaria Japonesa/Suiza), toda devolución requiere una inspección técnica obligatoria para verificar que no hubo cambio de piezas internas o manipulación de pernos.</p>
            <p><strong>3. ESTADO ESTÉTICO:</strong> Solo se aceptan devoluciones si la pieza mantiene sus protectores originales y está libre de micro-rayones.</p>
          </div>
          <button onClick={() => setShowTerms(false)} style={{ marginTop: "40px", background: "#0D1B2A", color: "#E0C56E", padding: "15px 50px", border: "none", fontWeight: "bold", borderRadius: "5px" }}>ACEPTAR</button>
        </div>
      )}
    </div>
  );
